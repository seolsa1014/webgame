...
<head>
   ...
   <script>
        function redirectToNextPage(option) {
            window.location.href = 'next16.jsp?option=' + option;
        }
    </script>
      <style>
    body {
    ...
    height: 800px;
    background: url('css/day16.png') center/100% 100% no-repeat;
}
    </style>
</head>
...
<div class="announcement">
    <p>Discovery of ruins near the kingdom, making people curious about what might happen</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">Explore the ruins / 1/4 chance of +10 Gold, 1/4 of +5 Gold, 1/4 of -5 Gold, 1/4 of -10 Gold</button>
    <button class="button" onclick="redirectToNextPage('option2')">Do not explore.</button>
</div>
