...
<head>
    ...
    <script>
        function redirectToNextPage(option) {
            window.location.href = 'next14.jsp?option=' + option;
        }
    </script>
      <style>
    body {
    ...
    height: 800px;
    background: url('css/day14.png') center/100% 100% no-repeat;
}
    </style>
</head>
...
<div class="announcement">
    <p>A fortuneteller has arrived, claiming to read fortunes.</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">Consult the fortuneteller / -5 Gold, 50% chance of +1 happiness, 50% chance of -1 </button>
    <button class="button" onclick="redirectToNextPage('option2')">Do not consult.</button>
</div>
