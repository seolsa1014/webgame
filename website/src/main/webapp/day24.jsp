...
<head>
    ...
    <script>
        function redirectToNextPage(option) {
            window.location.href = 'next24.jsp?option=' + option;
        }
    </script>
      <style>
    body {
    ...
    height: 800px;
    background: url('css/day24.png') center/100% 100% no-repeat;
}
    </style>
</head>
...
<div class="announcement">
    <p>Soldiers are demanding additional rewards for their efforts.</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">Grant rewards / Gold -5</button>
     <button class="button" onclick="redirectToNextPage('option2')">Refuse / soldiers -5</button>
