...
<head>
   ...
   <script>
        function redirectToNextPage(option) {
            window.location.href = 'next11.jsp?option=' + option;
        }
    </script>  <style>
    body {
    margin: 0;
...
<div class="announcement">
    <p>The village's annual festival is approaching. It's an opportunity to host a festival.</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">Host the festival grandly /  Gold -10, Food -10, happiness +3</button>
    <button class="button" onclick="redirectToNextPage('option2')">Host the festival modestly / Gold -5, Food -5, happiness +2</button>
    <button class="button" onclick="redirectToNextPage('option3')">Ignore it.</button>
</div>
