...
<head>
   ...
   <script>
        function redirectToNextPage(option) {
            window.location.href = 'next19.jsp?option=' + option;
        }
    </script>
      <style>
    body {
    ...
    height: 800px;
    background: url('css/day19.png') center/100% 100% no-repeat;
}
    </style>
</head>
...
<div class="announcement">
    <p>Unexpected appearance of a new herd of animals near the kingdom. They are consuming a significant amount of food.</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">Crops have suffered damage / food - 5</button>
     <button class="button" onclick="redirectToNextPage('option2')">Unable to do anything / happiness -1</button>
</div>
