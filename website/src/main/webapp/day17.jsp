...
<head>
    ...
    <script>
        function redirectToNextPage(option) {
            window.location.href = 'next17.jsp?option=' + option;
        }
    </script>
      <style>
    body {
    ...
    height: 800px;
    background: url('css/day17.png') center/100% 100% no-repeat;
}
    </style>
</head>
...
<div class="announcement">
    <p>A scientist claims to have a groundbreaking technology to increase food production.</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">Trust the scientist / 1/2 chance of +5 Food, 1/2 chance of -5 Food</button>
    <button class="button" onclick="redirectToNextPage('option2')">Play it safe / -5 Gold, +5 Food</button>
     <button class="button" onclick="redirectToNextPage('option3')">Do not trust.</button>
</div>
