...
<head>
    ...
    <script>
        function redirectToNextPage(option) {
            window.location.href = 'next5.jsp?option=' + option;
        }
    </script>
      <style>
    body {
    ...
    height: 800px;
    background: url('css/day5.png') center/100% 100% no-repeat;
}
    </style>
</head>
...
<div class="announcement">
    <p>In the kingdom, a tournament is held where skilled knights engage in duels. This tournament will help enhance the combat abilities of the kingdom's knights and facilitate the exchange of various techniques.</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">Increase the tournament prize money to motivate participants / soldiers + 10</button>
    <button class="button" onclick="redirectToNextPage('option2')">Expand the scale of the tournament to attract a larger audience / happiness + 1</button>
</div>
