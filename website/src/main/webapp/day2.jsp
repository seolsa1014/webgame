...
<head>
    ...
    <script>
        function redirectToNextPage(option) {
            window.location.href = 'next2.jsp?option=' + option;
        }
    </script>
    <style>
    body {
    ...
    height: 800px;
    background: url('css/day2.png') center/100% 100% no-repeat;
}
    </style>
</head>
...
<div class="announcement">
    <p>The farmers around the kingdom have developed a new agricultural technology. It is anticipated that implementing this technology will result in a higher yield of food.</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">You earned food / Food + 10</button>
</div>
