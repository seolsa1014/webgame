...
<head>
    ...
    <script>
        function redirectToPreviousPage() {
            window.location.href = 'day13.jsp';
        }
    </script>
    <style>
        body {
    ...
    <%
        ...
        try {
            ...
            if ("option1".equals(selectedOption)) {
                ...
                // 자원 부족 시 경고 처리
                if (food >= 5) {
                    String updateQuery = "UPDATE users SET gold = gold + 10, food = food - 5 WHERE name = ?";
                    ...
                    out.println("<script>window.location.href='day13.jsp';</script>");
                    return;
                }
                ...
                // 자원 부족 시 경고 처리
                if (food >= 5) {
                    String updateQuery = "UPDATE users SET food = food - 5, happiness = happiness + 1 WHERE name = ?";
                    pstmt = conn.prepareStatement(updateQuery);
                    pstmt.setString(1, loggedInName);
                    pstmt.executeUpdate();
                } else {
