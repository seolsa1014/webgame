...
<head>
    ...
    <script>
        function redirectToNextPage(option) {
            window.location.href = 'next3.jsp?option=' + option;
        }
    </script>
       <style>
    body {
    ...
    height: 800px;
    background: url('css/day3.png') center/100% 100% no-repeat;
}
    </style>
</head>
...
<div class="announcement">
    <p>A remarkable military expert has emerged in the vicinity of the kingdom. He possesses the ability to enhance the kingdom's military strength and efficiently train its forces.</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">The soldiers have been well-trained. / Soldiers + 10</button>
</div>
