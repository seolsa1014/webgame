...
<head>
    ...
    <script>
        function redirectToNextPage(option) {
            window.location.href = 'next22.jsp?option=' + option;
        }
    </script>
      <style>
    body {
    ...
    height: 800px;
    background: url('css/day22.png') center/100% 100% no-repeat;
}
    </style>
</head>
...
<div class="announcement">
    <p>The village is facing a famine, and the kingdom's treasury needs to be opened for relief.</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">Distribute food /  Food -5</button>
     <button class="button" onclick="redirectToNextPage('option2')">Provide funds for food / Gold -5</button>
