...
<head>
    ...
    <script>
        function redirectToNextPage(option) {
            window.location.href = 'next21.jsp?option=' + option;
        }
    </script>
      <style>
    body {
    ...
    height: 800px;
    background: url('css/day21.png') center/100% 100% no-repeat;
}
    </style>
</head>
...
<div class="announcement">
    <p>False rumors circulating within the kingdom about a royal planning rebellion. This has caused a rapid decline in satisfaction.</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">Something significant has happened. / happiness - 1</button>
</div>
