...
<head>
    ...
    <script>
        function redirectToNextPage(option) {
            window.location.href = 'next27.jsp?option=' + option;
        }
    </script>
      <style>
    body {
    ...
    height: 800px;
    background: url('css/day27.png') center/100% 100% no-repeat;
}
    </style>
</head>
...
<div class="announcement">
    <p>Flooding has occurred in the vicinity of the kingdom, causing damage to farmland. </p>
</div>
