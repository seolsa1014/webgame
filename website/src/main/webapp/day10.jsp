...
<head>
    ...
    <script>
        function redirectToNextPage(option) {
            window.location.href = 'next10.jsp?option=' + option;
        }
    </script>
      <style>
    body {
...
<div class="announcement">
    <p>The kingdom is considering a restructuring of the military budget.</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">Increase the budget / Gold -5, soldiers + 10</button>
    <button class="button" onclick="redirectToNextPage('option2')">Decrease the budget /  Gold +5,soldiers -10</button>
    <button class="button" onclick="redirectToNextPage('option3')">Cancel the restructuring.</button>
</div>
