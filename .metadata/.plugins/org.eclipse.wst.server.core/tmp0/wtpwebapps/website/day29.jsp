...
<head>
    ...
    <script>
        function redirectToNextPage(option) {
            window.location.href = 'next29.jsp?option=' + option;
        }
    </script>
      <style>
    body {
    ...
    height: 800px;
    background: url('css/day29.png') center/100% 100% no-repeat;
}
    </style>
</head>
...
<div class="announcement">
    <p>The kingdom is planning to implement a support policy for rural development.</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">Implement the policy / Gold -5, Food +5</button>
     <button class="button" onclick="redirectToNextPage('option2')">Support the military / Gold -5, Military Strength +10</button>
      <button class="button" onclick="redirectToNextPage('option3')">Do not implement.</button>
</div>
