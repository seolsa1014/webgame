    ...
    <link rel="stylesheet" type="text/css" href="css/day.css">
     <script>
        function redirectToNextPage(option) {
            window.location.href = 'next7.jsp?option=' + option;
        }
    </script>
      <style>
    body {
...
<div class="announcement">
    <p>Supporting artists and writers in the kingdom.</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">Sponsor artists / gold - 5, happiness + 1</button>
    <button class="button" onclick="redirectToNextPage('option2')">Do not provide sponsorship.</button>
</div>
