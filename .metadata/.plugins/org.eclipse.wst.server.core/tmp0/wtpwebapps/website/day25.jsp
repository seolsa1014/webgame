...
<head>
    ...
    <script>
        function redirectToNextPage(option) {
            window.location.href = 'next25.jsp?option=' + option;
        }
    </script>
      <style>
    body {
    ...
    height: 800px;
    background: url('css/day25.png') center/100% 100% no-repeat;
}
    </style>
</head>
...
<div class="announcement">
    <p>Bandits have raided a village. Options for resolution are available.</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">Support people with food / Food -5 </button>
      <button class="button" onclick="redirectToNextPage('option2')">Support people with funds / Gold -5</button>
