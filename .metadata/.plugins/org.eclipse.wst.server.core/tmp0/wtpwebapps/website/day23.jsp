...
<head>
    ...
    <script>
        function redirectToNextPage(option) {
            window.location.href = 'next23.jsp?option=' + option;
        }
    </script>
      <style>
    body {
    ...
    height: 800px;
    background: url('css/day11.png') center/100% 100% no-repeat;
}
    </style>
</head>
...
<div class="announcement">
    <p>The military experiences a decline in combat capabilities after a battle. Efforts are needed to boost soldiers' morale.</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">Increase supplies / Food -5</button>
    <button class="button" onclick="redirectToNextPage('option2')">Difficult to provide support / soldiers -5</button>
    <button class="button" onclick="redirectToNextPage('option3')">Unable to do anything / happiness -1</button>
</div>
