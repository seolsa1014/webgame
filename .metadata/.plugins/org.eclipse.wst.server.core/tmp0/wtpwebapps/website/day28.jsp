...
<head>
   ...
   <script>
        function redirectToNextPage(option) {
            window.location.href = 'next28.jsp?option=' + option;
        }
    </script>
      <style>
    body {
    ...
    height: 800px;
    background: url('css/day28.png') center/100% 100% no-repeat;
}
    </style>
</head>
...
<div class="announcement">
    <p>Farmers in the vicinity have obtained a more abundant harvest than anticipated. What should be done with these crops?</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">sell food / gold + 5</button>
    <button class="button" onclick="redirectToNextPage('option2')">Harvest them / food + 5</button>
</div>
