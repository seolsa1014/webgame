...
<head>
    ...
    height: 800px;
    background: url('css/day4.png') center/100% 100% no-repeat;
}
    </style>
   <script>
        function redirectToNextPage(option) {
            window.location.href = 'next4.jsp?option=' + option;
        }
    </script>
</head>
...
<div class="announcement">
    <p>An artistic event is set to take place in the vicinity of the kingdom. If the king participates, the people will have the opportunity to enjoy a new cultural activity.</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">People are satisfied. / happiness + 1</button>
</div>
