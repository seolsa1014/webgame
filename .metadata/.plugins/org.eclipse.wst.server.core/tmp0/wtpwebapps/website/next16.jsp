...
<head>
    ...
    <script>
        function redirectToPreviousPage() {
            window.location.href = 'day16.jsp';
        }
    </script>
    <style>
        body {
        ...
        try {
            ...
            if ("option1".equals(selectedOption)) {
                ...
                // 골드 부족 시 경고 처리
                    ...
                    String updateQuery = "";
                	int randomChance = new Random().nextInt(4); // 0 또는 1
                    if (randomChance == 0) {
                      
                    	updateQuery = "UPDATE users SET gold = gold + 10 WHERE name = ?";
                    }
                    else if(randomChance == 1)
                    {
                    	updateQuery = "UPDATE users SET gold = gold + 5 WHERE name = ?";
                    }
