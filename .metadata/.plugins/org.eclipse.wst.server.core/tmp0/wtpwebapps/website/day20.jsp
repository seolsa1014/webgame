...
<head>
    ...
    <script>
        function redirectToNextPage(option) {
            window.location.href = 'next20.jsp?option=' + option;
        }
    </script>
      <style>
    body {
    ...
    height: 800px;
    background: url('css/day20.png') center/100% 100% no-repeat;
}
    </style>
</head>
...
<div class="announcement">
    <p>A wyvern has invaded the palace! The military must engage in combat.</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">Deploy the troops! / soldiers - 10</button>
