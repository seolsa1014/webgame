    ...
    <link rel="stylesheet" type="text/css" href="css/day.css">
     <script>
        function redirectToNextPage(option) {
            window.location.href = 'next8.jsp?option=' + option;
        }
    </script>
      <style>
    body {
...
<div class="announcement">
    <p>A pirate attack has occurred along the kingdom's coast..</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">Retaliate and seize the loot / soldiers - 5,gold + 10</button>
    <button class="button" onclick="redirectToNextPage('option2')">Pay a ransom / Food - 5</button>
    <button class="button" onclick="redirectToNextPage('option3')">Do nothing / happiness - 1</button>
</div>
