...
<head>
    ...
    <script>
        function redirectToNextPage(option) {
            window.location.href = 'next26.jsp?option=' + option;
        }
    </script>
      <style>
    body {
    ...
    height: 800px;
    background: url('css/day26.png') center/100% 100% no-repeat;
}
    </style>
</head>
...
<div class="announcement">
    <p>The kingdom is under attack by sudden locusts, resulting in a shortage of food.</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">That's unfortunate / food - 5</button>
