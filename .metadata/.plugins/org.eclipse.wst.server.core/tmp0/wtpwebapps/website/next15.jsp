...
<head>
    ...
    <script>
        function redirectToPreviousPage() {
            window.location.href = 'day15.jsp';
        }
    </script>
    <style>
        body {
    ...
    <%
        ...
        try {
            ...
            if ("option1".equals(selectedOption)) {
                // 옵션 1: Increase the budget / Gold -5, soldiers + 10
                // 골드 부족 시 경고 처리
                if (soldiers >= 20) {
                    ...
                    // 사용자의 데이터베이스 업데이트
                     ...
                     String	updateQuery = "UPDATE users SET gold = gold + 5, food = food + 5,soldiers = soldiers - 20 WHERE name = ?";
            	...
            	if (gold >= 5) {
                    ...
                    // 사용자의 데이터베이스 업데이트
                     ...
                     String	updateQuery = "UPDATE users SET gold = gold - 5, food = food + 5,happiness = happiness + 1 WHERE name = ?";
                    ...
                    out.println("<script>window.location.href='day15.jsp';</script>");
                    return;
                }
            }
            else
