...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/day.css">
      <script>
        function redirectToNextPage(option) {
            window.location.href = 'next6.jsp?option=' + option;
        }
    </script>
      <style>
    body {
    ...
    height: 800px;
    background: url('css/day6.png') center/100% 100% no-repeat;
}
    </style>
</head>
...
<div class="announcement">
    <p>There is an opportunity for the kingdom to enter into a new trade agreement.</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">Buy food / gold - 5,food + 5</button>
    <button class="button" onclick="redirectToNextPage('option2')">Sell food / gold + 5,food - 5</button>
    <button class="button" onclick="redirectToNextPage('option3')">Do not engage in trade.</button>
</div>
