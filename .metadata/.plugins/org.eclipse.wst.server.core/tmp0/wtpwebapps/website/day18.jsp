...
<head>
    ...
    <script>
        function redirectToNextPage(option) {
            window.location.href = 'next18.jsp?option=' + option;
        }
    </script>
      <style>
    body {
    ...
    height: 800px;
    background: url('css/day18.png') center/100% 100% no-repeat;
}
    </style>
</head>
...
<div class="announcement">
    <p>Feeling overwhelmed by excessive work, you decide to indulge in some entertainment.</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">Gamble / happiness -1, 1/2 chance of +10 Gold</button>
    <button class="button" onclick="redirectToNextPage('option2')">Risky gamble / happiness -1, 1/3 chance of +15 Gold</button>
    <button class="button" onclick="redirectToNextPage('option3')">All in! / happiness -1, 1/4 chance of +20 Gold</button>
</div>
