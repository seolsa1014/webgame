...
<head>
    ...
    <script>
        function redirectToNextPage(option) {
            window.location.href = 'next30.jsp?option=' + option;
        }
    </script>
      <style>
    body {
    ...
    height: 800px;
    background: url('css/day30.png') center/100% 100% no-repeat;
}
    </style>
</head>
...
<div class="announcement">
    <p>Due to an earthquake, a crucial bridge in the town has been destroyed. It needs to be repaired.</p>
</div>

<div class="buttons">
    <button class="button" onclick="redirectToNextPage('option1')">That's unfortunate / gold - 5</button>
